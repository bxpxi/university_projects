...
void testavanseazaKpasi(Relatie r){
    MDO d = MDO(r);
    IteratorMDO it = d.iterator();
    assert(!it.valid());
    it.prim();
    ...
    itD.avanseazaKpasi(2);
    while (itD.valid()) {
        TCheie c1 = itD.element().first;
        itD.urmator();
        TCheie c2 = itD.element().first;
        itD.urmator();
        TCheie c3 = itD.element().first;
        itD.urmator();
        assert(r(cPrec, c3));
        cPrec = c3;
        itD.avanseazaKpasi(2);
...
void testavanseaza(){
    testavanseazaKpasi(cresc);
    testavanseazaKpasi(desc);
}
